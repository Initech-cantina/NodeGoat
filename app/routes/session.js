...
function SessionHandler(db) {
    ...
    this.handleLoginRequest = (req, res, next) => {
        ...
        // Fix for Auth Bypass - Reject non-string credentials at login
    ...
    const validateSignup = (userName, firstName, lastName, password, verify, email, errors) => {
        ...
        */
        ...
        // Fix for Auth Bypass - Enforce string types on all required fields
        if (typeof userName !== "string" || typeof firstName !== "string" ||
            typeof lastName !== "string") {
            errors.userNameError = "All fields are required and must be text.";
            return false;
        }
        ...
        // Fix for Auth Bypass - Reject non-string, null, or empty passwords
